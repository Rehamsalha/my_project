            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
                        ...
                        document.getElementById('logout-form').submet();">>
                         {{ _('Logout') }}
                        </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('logout')}}">ADMIN <span class="sr-only">(current)</span></a>
                </li>
            ...
            <div class="sidebar">
                <div>
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="#" class="d-block">ريهام صالحة</a>
                        </div>
                    </div>
